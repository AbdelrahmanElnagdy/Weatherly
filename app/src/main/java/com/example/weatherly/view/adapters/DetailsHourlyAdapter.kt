...
class DetailsHourlyAdapter (hourlyItem: ArrayList<HourlyItem>, context: Context, currentLocation: String,var lat: String,var lon: String): RecyclerView.Adapter<DetailsHourlyAdapter.ViewHolder>() {
